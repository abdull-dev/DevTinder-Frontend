...
export function MatchCard() {
  return (
    <div className="glass-panel rounded-xl p-6 flex flex-col items-center text-center shadow-[0_10px_30px_rgba(115,54,205,0.1)] relative overflow-hidden group">
      ...
      {/* Profile image */}
      <div className="w-24 h-24 rounded-full overflow-hidden mb-4 border-4 border-white shadow-[0_0_15px_rgba(255,117,140,0.3)] relative z-10">
        <Image
          src={MATCH_CARD.IMAGE_SRC}
      ...
      {/* User info */}
      <h3 className="text-[28px] leading-[1.2] font-bold mb-1 relative z-10">
        {MATCH_CARD.NAME}
      </h3>
